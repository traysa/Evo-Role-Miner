...
\label{sec:A_Exp1}
	...
	\label{sec:A_Exp1_Diagrams}
		\begin{figure}[H]
			\centering
		    \includegraphics[scale=0.33, trim=4cm 2cm 4cm 0cm, clip=true]{exp1avgConf}
		...
		\begin{figure}[H]
			\centering
		    \includegraphics[scale=0.33, trim=4cm 2cm 4cm 0cm, clip=true]{exp1roleCnt}
		...
		\begin{figure}[H]
			\centering
		    \includegraphics[scale=0.33, trim=4cm 2cm 4cm 0cm, clip=true]{exp1urCnt}
		...
		\begin{figure}[H]
		    \centering
		    \includegraphics[scale=0.33, trim=4cm 2cm 4cm 0cm, clip=true]{exp1rpCnt}
...
\label{sec:A_Exp2a}
	...
	\label{sec:A_Exp2a_Diagrams}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.4, trim=0cm 2cm 0cm 0cm, clip=true]{exp2aFitness}
...
\label{sec:A_Exp2b}
	...
	\label{sec:A_Exp2b_Diagrams}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.4, trim=0cm 2cm 0cm 0cm, clip=true]{exp2bFitness}
...
\label{sec:A_Exp3a}
	...
	\label{sec:A_Exp3a_Diagrams}
		\begin{figure}[H]
	    	\centering
	    	\includegraphics[scale=0.4, trim=0cm 2cm 0cm 0cm, clip=true]{exp3aFitness}
...
\label{sec:A_Exp3b}
	...
	\label{sec:A_Exp3b_Diagrams}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.4, trim=0cm 2cm 0cm 0cm, clip=true]{exp3bFitness}
...
\label{sec:A_Exp4a}
	...
	\label{sec:A_Exp4a_Diagrams}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.37, trim=4cm 2cm 4cm 2cm, clip=true]{exp4aBasic_RM}
...
\label{sec:A_Exp4b}
	...
	\label{sec:A_Exp4b_Diagrams}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.37, trim=4cm 2cm 4cm 2cm, clip=true]{exp4bEdge_RM}
