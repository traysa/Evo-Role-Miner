...
def selNSGA2(individuals, k, probabilitiesForObjectives=[1.0,1.0]):
    ...
    pareto_fronts, ranks = sortFastND(fitnesses, k, probabilitiesForObjectives)
...
def sortFastND(fitnesses, k, probabilitiesForObjectives, first_front_only=False):
